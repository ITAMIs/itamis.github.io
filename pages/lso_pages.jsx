...
import { fadeIn, staggerContainer, zoomIn, textVariant } from "../utils/motion";
  ...
  <section className={`${styles.paddings} bg-primary-black overflow-hidden`}>
      ...
      >
        ...
        >
          ...
          <div className=" ">
            <div className="">
              <div className="text-white p-4 border rounded-md border-gray-400  w-full font-bold">Landing Page</div>
              <img
                src="/landingpage.jpg"
                alt="landing_example"
        ...
        >
          ...
          <div className=" ">
            <div className="">
            <div className="text-white p-4 border rounded-md border-gray-400  w-full font-bold">Sales Page</div>
              <img
                src="/salespage.jpg"
                alt="sales_example"
                className="bg-white border rounded-md border-gray-400 p-2 w-full"
        ...
        >
          <div className="feedback-gradient pointer-events-none" />
            ...
            <div className="">
            <div className="text-white p-4 border rounded-md border-gray-400  w-full font-bold">Opt-in Page</div>
              <img
                src="/opt-inpage.jpg"
                alt="opt-in_example"
                className="bg-white border rounded-md border-gray-400 p-2 w-full"
